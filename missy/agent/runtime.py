...
class AgentConfig:
    ...
    system_prompt: str = (
        ...
        "Browser tools (use these for web): browser_navigate, browser_click, "
        "browser_fill, browser_screenshot, browser_get_content, browser_evaluate, "
        "browser_wait, browser_get_url, browser_close. "
        "Prefer browser_* tools over x11_click for browser interaction. "
