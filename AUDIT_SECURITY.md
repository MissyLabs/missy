...
/home/missy/missy-loops/missy/LAST_SESSION_SUMMARY.md:7:- Added Web/API candidate review endpoints:
/home/missy/missy-loops/missy/LAST_SESSION_SUMMARY.md:8:  `GET /api/v1/tool-candidates` and `GET /api/v1/tool-candidates/{id}`.
/home/missy/missy-loops/missy/LAST_SESSION_SUMMARY.md:9:- Added candidate safe controls:
/home/missy/missy-loops/missy/LAST_SESSION_SUMMARY.md:10:  `tool_candidate.import_benchmarks`, `tool_candidate.approve`,
/home/missy/missy-loops/missy/LAST_SESSION_SUMMARY.md:11:  `tool_candidate.enable`, and `tool_candidate.deny`.
/home/missy/missy-loops/missy/LAST_SESSION_SUMMARY.md:14:  structured `web.control` audit allow/deny events.
/home/missy/missy-loops/missy/LAST_SESSION_SUMMARY.md:17:- API startup now attaches candidate and benchmark stores so the browser
/home/missy/missy-loops/missy/LAST_SESSION_SUMMARY.md:18:  console can surface eligible candidate controls through `GET /api/v1/controls`.
/home/missy/missy-loops/missy/LAST_SESSION_SUMMARY.md:20:- Added API tests for candidate list/show, control target discovery,
/home/missy/missy-loops/missy/LAST_SESSION_SUMMARY.md:21:  import/approve/enable, deny safeguards, and lifecycle-gate rejection.
/home/missy/missy-loops/missy/LAST_SESSION_SUMMARY.md:26:python3 -m pytest tests/api/test_server.py::TestOperatorControls tests/tools/test_benchmark_reconciler.py tests/tools/test_candidate_store.py tests/cli/test_tool_provider_cli.py -q
...
/home/missy/missy-loops/missy/LAST_SESSION_SUMMARY.md:58:Implement the controlled loader for enabled approved candidates, keeping it
/home/missy/missy-loops/missy/LAST_SESSION_SUMMARY.md:59:behind policy, provenance, schema, benchmark/provider-enable, test, and
/home/missy/missy-loops/missy/LOOP_INSTRUCTIONS.md:5:Primary focus: complete tool usage and tool intelligence overhaul
/home/missy/missy-loops/missy/LOOP_INSTRUCTIONS.md:6:Branch: overhaul/tools-20260709-174109
/home/missy/missy-loops/missy/LOOP_INSTRUCTIONS.md:10:- Treat complete tool usage and tool intelligence overhaul as the current primary overhaul.
/home/missy/missy-loops/missy/LOOP_INSTRUCTIONS.md:11:- Keep the design flexible for future non-tool overhauls.
...
/home/missy/missy-loops/missy/fixes.md:292:  2. Add `missy audit egress [--since] [--host]` that aggregates `network_request` audit events
/home/missy/missy-loops/missy/fixes.md:294:     `~/.missy/audit.jsonl`.
/home/missy/missy-loops/missy/fixes.md:301:  write-through on create/touch/delete). Add a `last_provider` column so `/chat` can resume with the
/home/missy/missy-loops/missy/fixes.md:302:  correct provider after a restart.
/home/missy/missy-loops/missy/fixes.md:312:4. **4.3** provider traffic bypasses gateway (security/audit, high) → enables 6.2.
/home/missy/missy-loops/missy/fixes.md:316:*Note:* several fixes have existing tests under `tests/` (policy, scheduler, providers,
