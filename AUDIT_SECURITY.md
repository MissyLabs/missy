...
/home/missy/missy/LAST_SESSION_SUMMARY.md:8:  `provider.set_default` operator control.
/home/missy/missy/LAST_SESSION_SUMMARY.md:9:- Added authenticated `/api/v1/controls` and POST
/home/missy/missy/LAST_SESSION_SUMMARY.md:10:  `/api/v1/controls/provider.set_default` routes.
/home/missy/missy/LAST_SESSION_SUMMARY.md:11:- Enforced exact confirmation strings, safe provider target validation,
/home/missy/missy/LAST_SESSION_SUMMARY.md:13:  `web.control` audit events for allow and deny outcomes.
/home/missy/missy/LAST_SESSION_SUMMARY.md:14:- Added a Web TUI Controls panel that displays provider targets and can switch
/home/missy/missy/LAST_SESSION_SUMMARY.md:15:  the default provider after a browser confirmation.
/home/missy/missy/LAST_SESSION_SUMMARY.md:17:  `missy/api/web_console.py`.
/home/missy/missy/LAST_SESSION_SUMMARY.md:18:- Added API tests for controls auth, listing, confirmation denial, successful
/home/missy/missy/LAST_SESSION_SUMMARY.md:19:  provider switching, audit output, and browser CSRF denial.
/home/missy/missy/LAST_SESSION_SUMMARY.md:46:- Safe controls are only started; tools, jobs, channels, and experimental
/home/missy/missy/LAST_SESSION_SUMMARY.md:47:  features still need policy-gated controls.
/home/missy/missy/LAST_SESSION_SUMMARY.md:48:- Run/session streaming viewer is still not implemented.
/home/missy/missy/LAST_SESSION_SUMMARY.md:49:- Live diagnostics probes should be added carefully behind policy and timeout
/home/missy/missy/LAST_SESSION_SUMMARY.md:57:then add the next small safe controls API slice for tool or scheduled-job
/home/missy/missy/LAST_SESSION_SUMMARY.md:58:enablement with explicit policy and audit behavior.
